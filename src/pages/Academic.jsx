...
export default function Academic() {
  const [terms, setTerms]                 = useFirestoreCollection("dashboard-academic-terms", [], 1);
  const [newTermName, setNewTermName]     = useState("");
  const [newTermStatus, setNewTermStatus] = useState("ongoing");
  const [editingTermId, setEditingTermId] = useState(null);

  const [tasks, setTasks]               = useFirestoreCollection("dashboard-academic-tasks", [], 1);
  const [tests, setTests]               = useFirestoreCollection("dashboard-academic-tests", [], 1);
