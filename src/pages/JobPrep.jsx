...
export default function JobPrep() {
  const [applications, setApplications] = useFirestoreCollection("dashboard-jobs-applications", [], 1);
  const [skills, setSkills] = useFirestoreCollection("dashboard-jobs-skills", [], 1);
  const [resources, setResources] = useFirestoreCollection("dashboard-jobs-resources", [], 1);
